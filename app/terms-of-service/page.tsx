    ...
    <main className="min-h-screen">
      <Container>
        ...
        <div className=" px-6 py-4 bg-base-100 opacity-80 backdrop-blur-md w-full mx-auto max-w-3xl">
          ...
          <div className="mt-4">
            <h3 className="font-bold underline">Intellectual Property</h3>
            <p>
          ...
          {/* Acceptable Use */}
          <div className="mt-4">
            <h3 className="font-bold underline">Acceptable Use</h3>
            <p>
          ...
          {/* User Contributions */}
          <div className="mt-4">
            <h3 className="font-bold underline">User Contributions</h3>
          ...
          {/* Accounts */}
          <div className="mt-4">
            <h3 className="font-bold underline">Accounts</h3>
            <p>
              When you create an account on our Site, you agree to the
              following:
            </p>
            <ol start={1} className="list-decimal [&>*]:mb-5 pl-8">
              <li>
          ...
          <div className="mt-4">
            <h3 className="font-bold underline">User Goods and Services</h3>
            <p>
          ...
          <div className="mt-4">
            <h3 className="font-bold underline">Links to Other Websites</h3>
            <p>
          ...
          <div className="mt-4">
            <h3 className="font-bold underline">Limitation of Liability</h3>
            <p>
          ...
          {/*  Indemnity */}
          <div className="mt-4">
            <h3 className="font-bold underline">Indemnity</h3>
            <p>
          ...
          {/* Applicable Law */}
          <div className="mt-4">
            <h3 className="font-bold underline">Applicable Law</h3>
            <p>
          ...
          {/* Severability */}
          <div className="mt-4">
            <h3 className="font-bold underline">Severability</h3>
            <p>
          ...
          {/* Changes */}
          <div className="mt-4">
            <h3 className="font-bold underline">Changes</h3>
            <p>
          ...
          {/* Contact Details */}
          <div className="my-4">
            <h3 className="font-bold underline">Contact Details</h3>
            <p>
